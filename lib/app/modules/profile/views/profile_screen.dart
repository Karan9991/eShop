...
import 'package:shopperz/app/modules/profile/widgets/web_view_page.dart';
                  ...
                  child: Column(
                    children: [
                      SizedBox(
                       ...
                       SizedBox(
                        height: box.read('isLogedIn') != false? 175.h : 185.h,
                         child: Column(
                                children: [
                                      ...
                                      children: [
                                        profileItem(
                                            WebViewPage(
                                              url: ApiList.baseUrl +
                                                  "#/page/" +
                                                  "${profile.pagesModel!.data![index].slug.toString()}",
                                              tittle: profile.pagesModel!
                                                  .data![index].title
                                                  .toString(),
                                            ),
                                            SvgIcon.tc,
