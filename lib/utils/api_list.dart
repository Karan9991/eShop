class ApiList {
  ...
  static const resendForgotOTPPhone = "$baseUrl/api/auth/forgot-password/otp-phone";
  static const resendForgotOTPEmail = "$baseUrl/api/auth/forgot-password/otp-email";
  static const verifyForgotPhone = "$baseUrl/api/auth/forgot-password/verify-phone";
  static const verifyForgotEmail = "$baseUrl/api/auth/forgot-password/verify-email";
  static const resetForgotPassword = "$baseUrl/api/auth/forgot-password/reset-password";
  ...
  static const promotion = "$baseUrl/api/frontend/promotion?status=5&type=5&order_type=asc";
  static const multiPromotion = "$baseUrl/api/frontend/promotion?status=5&type=10&order_type=asc";
  ...
  static const categoryWiseProduct = "$baseUrl/api/frontend/product/category-wise-products";
  ...
  static const relatedProducts = "$baseUrl/api/frontend/product/related-products/";
  static const initialVariation = "$baseUrl/api/frontend/product/initial-variation/";
  static const childrenVariation = "$baseUrl/api/frontend/product/children-variation/";
  static const finalVariation = "$baseUrl/api/frontend/product/variation/ancestors-and-self/";
  ...
  static const totalCompleteOrdersCount = "$baseUrl/api/frontend/overview/total-complete-orders";
  static const totalReturnOrdersCount = "$baseUrl/api/frontend/overview/total-return-orders";
  static const totalWalletBalanceCount = "$baseUrl/api/frontend/overview/wallet-balance";
  ...
  static const updateImage = "$baseUrl/api/frontend/product-review/upload-image/";
  static const deleteImage = "$baseUrl/api/frontend/product-review/delete-image/";
  static const showReturnOrders = "$baseUrl/api/frontend/return-order";
  static const showReturnOrdersDetails = "$baseUrl/api/frontend/return-order/show/";
  ...
  static const paymentGateway = "$baseUrl/api/frontend/payment-gateway?status=5";
  ...
  static String mostPopular(String paginate, String page, String perPage) => "$baseUrl/api/frontend/product/popular-products?paginate=$paginate&page=$page&per_page=$perPage&order_type=asc&status=5";
